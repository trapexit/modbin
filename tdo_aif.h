...
void tdo_aif_set_subsystype(void *buf, uint8_t val);
void tdo_aif_set_type(void *buf, uint8_t val);
...
uint8_t     tdo_aif_get_subsystype(void *buf);
uint8_t     tdo_aif_get_type(void *buf);
